    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="#ames" id="ames" class="division-card group bg-white rounded-2xl border border-gray-100 overflow-hidden block">
                <div class="p-7">
                    <div class="flex items-start justify-between mb-5">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center shadow-lg shadow-emerald-500/20">
                            <span class="text-sm font-extrabold text-white">AMES</span>
                        </div>
                        <svg class="division-arrow w-5 h-5 text-gray-300 group-hover:text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Medical Equipment</h3>
                    ...
                    <div class="mt-5 flex items-center gap-2 text-xs font-semibold text-emerald-600">
                        <span>Local & International Supply</span>
                    </div>
                </div>
                <div class="h-1.5 bg-gradient-to-r from-emerald-500 to-emerald-700"></div>
            </a>
            ...
            <a href="#aphamko" id="aphamko" class="division-card group bg-white rounded-2xl border border-gray-100 overflow-hidden block">
                <div class="p-7">
                    <div class="flex items-start justify-between mb-5">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center shadow-lg shadow-gold-500/20">
                            <span class="text-[10px] font-extrabold text-white">APHAMKO</span>
                        </div>
                        <svg class="division-arrow w-5 h-5 text-gray-300 group-hover:text-gold-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Pharmaceuticals</h3>
                    ...
                    <div class="mt-5 flex items-center gap-2 text-xs font-semibold text-gold-600">
                        <span>Wholesale & Nationwide Delivery</span>
                    </div>
                </div>
                <div class="h-1.5 bg-gradient-to-r from-gold-400 to-gold-600"></div>
            </a>
            ...
            <a href="#asca" id="asca" class="division-card group bg-white rounded-2xl border border-gray-100 overflow-hidden block">
                <div class="p-7">
                    <div class="flex items-start justify-between mb-5">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-400 to-rose-600 flex items-center justify-center shadow-lg shadow-rose-500/20">
                            <span class="text-sm font-extrabold text-white">ASCA</span>
                        </div>
                        <svg class="division-arrow w-5 h-5 text-gray-300 group-hover:text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Natural Skin Care</h3>
                    ...
                    <div class="mt-5 flex items-center gap-2 text-xs font-semibold text-rose-600">
                        <span>Custom Products & Nationwide Delivery</span>
                    </div>
                </div>
            ...
            <a href="#physiotherapy" id="physiotherapy" class="division-card group bg-white rounded-2xl border border-gray-100 overflow-hidden block">
                <div class="p-7">
                    <div class="flex items-start justify-between mb-5">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-400 to-sky-600 flex items-center justify-center shadow-lg shadow-sky-500/20">
                        ...
                        <svg class="division-arrow w-5 h-5 text-gray-300 group-hover:text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Physiotherapy Services</h3>
                    ...
                    <div class="mt-5 flex items-center gap-2 text-xs font-semibold text-sky-600">
                        <span>Home Visits & Clinic-Based</span>
                    </div>
                </div>
                <div class="h-1.5 bg-gradient-to-r from-sky-400 to-sky-600"></div>
            </a>
            ...
            <a href="#amotech" id="amotech" class="division-card group bg-white rounded-2xl border border-gray-100 overflow-hidden block">
                <div class="p-7">
                    <div class="flex items-start justify-between mb-5">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center shadow-lg shadow-violet-500/20">
                            <span class="text-[10px] font-extrabold text-white">AMOTECH</span>
                        </div>
                        <svg class="division-arrow w-5 h-5 text-gray-300 group-hover:text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </div>
                    ...
                    <div class="mt-5 flex items-center gap-2 text-xs font-semibold text-violet-600">
                        <span>Web, Branding & Social Media</span>
                    </div>
                </div>
                <div class="h-1.5 bg-gradient-to-r from-violet-400 to-violet-600"></div>
            </a>

            {{-- CTA Card --}}
            <div class="division-card group bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-2xl overflow-hidden flex items-center justify-center p-7 text-center relative">
                <div class="absolute top-0 right-0 w-32 h-32 bg-gold-500/10 rounded-full -mr-16 -mt-16"></div>
                <div class="relative z-10">
                    <div class="w-14 h-14 mx-auto rounded-2xl bg-white/10 flex items-center justify-center mb-4">
...
<section id="appointment" class="py-20 sm:py-28 bg-emerald-900 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+255626371854" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-bold rounded-xl border border-white/30 transition-all hover:scale-105 text-base">
