...
@section('title', 'Confirm Password - ' . config('app.name', 'Amoleck Group Company LTD'))
...
<div class="w-full">
    <div class="bg-white rounded-none sm:rounded-2xl shadow-none sm:shadow-xl border-0 sm:border border-gray-100 overflow-hidden min-h-screen sm:min-h-0">
        ...
        <div class="px-6 sm:px-8 py-8 text-center border-b border-gray-100">
            <img src="{{ asset('amock_big_logo.png') }}" alt="Amoleck Group Company LTD" class="w-20 h-20 mx-auto mb-3 object-contain">
            ...
            <p class="text-emerald-600 text-xs font-semibold mt-2 tracking-wide">Your trusted partner in business excellence</p>
        </div>
    ...
    <p class="mt-6 text-center text-xs text-emerald-100/60 hidden sm:block">&copy; {{ date('Y') }} {{ config('app.name', 'Amoleck Group Company LTD') }}. All rights reserved.</p>
</div>
@endsection
